...
Egy iskolába $n$ fiú és $m$ lány jár. Következő héten bált szerveznek, ahol fiú-lány párokat kell alkotni. Előre ismert $k$ darab potenciális párjelölt. Találj egy olyan beosztást, ahol a lehető legtöbb fiú-lány pár tud majd egyszerre táncolni!
...
Minden lehetséges pár legfeljebb egyszer szerepel a párok leírásában.
